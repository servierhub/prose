...
/**
 * The SpriteSheet class represents a sprite sheet, which is a single image that
 * contains multiple frames of animation.
 * It allows for the extraction of individual frames from the sprite sheet and
 * the creation of sprite animations.
 *
 * To create a new SpriteSheet object, the sprite width, sprite height, and
 * image data representing the sprite sheet must be provided.
 *
 * Note: This class requires the Processing library to be imported.
 */
public class SpriteSheet {
    /**
     * Creates a new SpriteSheet object with the specified sprite width, sprite
     * height, and image data.
     *
     ...
     *
     * This method creates an array of PImage frames based on the startFrame,
     * numFrames, and frameRate parameters.
     * It calculates the x and y coordinates of each frame within the sprite sheet
     * using the spriteWidth and spriteHeight properties.
     * The frames are then extracted from the sprite sheet using the get() method of
     * the PImage data object.
     * Finally, a new SpriteAnimation object is created using the frames array and
     * frameRate, and returned.
     *
     ...
     * @return a SpriteAnimation object representing the extracted frames from the
     *         sprite sheet
     */
